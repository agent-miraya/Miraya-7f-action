...
(() => {
  ...
  // node_modules/.pnpm/jayson@4.1.3_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/jayson/lib/generateRequest.js
  var require_generateRequest = __commonJS({
    "node_modules/.pnpm/jayson@4.1.3_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/jayson/lib/generateRequest.js"(exports, module) {
      "use strict";
      init_esbuild_shims();
  ...
  // node_modules/.pnpm/jayson@4.1.3_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/jayson/lib/client/browser/index.js
  var require_browser2 = __commonJS({
    "node_modules/.pnpm/jayson@4.1.3_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/jayson/lib/client/browser/index.js"(exports, module) {
      "use strict";
      init_esbuild_shims();
      var uuid = (init_esm_browser(), __toCommonJS(esm_browser_exports)).v4;
  ...
  // node_modules/.pnpm/@noble+curves@1.7.0/node_modules/@noble/curves/esm/ed25519.js
  init_esbuild_shims();

  // node_modules/.pnpm/@noble+hashes@1.6.0/node_modules/@noble/hashes/esm/sha512.js
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@noble+curves@1.7.0/node_modules/@noble/curves/esm/abstract/edwards.js
  init_esbuild_shims();
  ...
  function twistedEdwards(curveDef) {
    ...
    function verify2(sig, msg, publicKey4, options = verifyOpts) {
      const { context, zip215 } = options;
      const len = Fp2.BYTES;
      sig = ensureBytes("signature", sig, 2 * len);
      msg = ensureBytes("message", msg);
      publicKey4 = ensureBytes("publicKey", publicKey4, len);
      if (zip215 !== void 0)
        abool("zip215", zip215);
      if (prehash)
        msg = prehash(msg);
      ...
      let A, R, SB;
      try {
        A = Point2.fromHex(publicKey4, zip215);
    ...
    _connect(address, options) {
      ...
      this.socket.addEventListener("message", ({ data: message }) => {
        if (message instanceof ArrayBuffer)
          message = import_buffer2.Buffer.from(message).toString();
        try {
  ...
  function weierstrass(curveDef) {
    ...
    function verify2(signature, msgHash, publicKey4, opts = defaultVerOpts) {
      const sg = signature;
      msgHash = ensureBytes("msgHash", msgHash);
      publicKey4 = ensureBytes("publicKey", publicKey4);
  ...
  function isOnCurve(publicKey4) {
    try {
      ed25519.ExtendedPoint.fromHex(publicKey4);
      return true;
    } catch {
      return false;
    }
  ...
  var PublicKey = class _PublicKey2 extends Struct2 {
     ...
     */
    toBuffer() {
      const b = this._bn.toArrayLike(import_buffer3.Buffer);
  ...
  var Message = class _Message {
    ...
    static from(buffer) {
      ...
      for (let i = 0; i < instructionCount; i++) {
        ...
        const data = import_bs58.default.encode(import_buffer3.Buffer.from(dataSlice));
        instructions.push({
          programIdIndex,
          accounts,
          data
  ...
  var DEFAULT_SIGNATURE = import_buffer3.Buffer.alloc(SIGNATURE_LENGTH_IN_BYTES).fill(0);
  ...
  var Transaction = class _Transaction {
    ...
    _addSignature(pubkey, signature) {
      ...
      this.signatures[index].signature = import_buffer3.Buffer.from(signature);
    }
    /**
    ...
    _getMessageSignednessErrors(message, requireAllSignatures) {
      ...
      for (const {
        ...
        if (signature === null) {
          ...
          if (!verify(signature, message, publicKey4.toBytes())) {
...
Missing signature for public key${sigErrors.missing.length === 1 ? "" : "(s)"} [\`${sigErrors.missing.map((p) => p.toBase58()).join("`, `")}\`].`;
    ...
    _serialize(signData) {
      ...
      signatures.forEach(({
        ...
        if (signature !== null) {
          ...
          import_buffer3.Buffer.from(signature).copy(wireTransaction, signatureCount.length + index * 64);
        }
      });
    ...
    static from(buffer) {
      ...
      for (let i = 0; i < signatureCount; i++) {
        ...
        signatures.push(import_bs58.default.encode(import_buffer3.Buffer.from(signature)));
      }
...
` + maybeLogsOutput + guideText;
  ...
  var bigInt = (length) => (property) => {
    ...
    bigIntLayout.decode = (buffer, offset2) => {
      ...
      return (0, import_bigint_buffer.toBigIntLE)(import_buffer3.Buffer.from(src));
    };
    bigIntLayout.encode = (bigInt3, buffer, offset2) => {
      const src = (0, import_bigint_buffer.toBufferLE)(bigInt3, length);
  ...
  var BufferFromRawAccountData = coerce(instance(import_buffer3.Buffer), RawAccountDataResult, (value) => import_buffer3.Buffer.from(value[0], "base64"));
  ...
  var ParsedOrRawAccountData = coerce(union([instance(import_buffer3.Buffer), ParsedAccountDataResult]), union([RawAccountDataResult, ParsedAccountDataResult]), (value) => {
    if (Array.isArray(value)) {
  ...
  var Keypair = class _Keypair {
    ...
    static fromSeed(seed) {
      const publicKey4 = getPublicKey(seed);
      const secretKey = new Uint8Array(64);
      secretKey.set(seed);
      secretKey.set(publicKey4, 32);
      return new _Keypair({
  ...
  var Secp256k1Program = class _Secp256k1Program {
    ...
    static publicKeyToEthAddress(publicKey4) {
      ...
      try {
        return import_buffer3.Buffer.from(keccak_256(toBuffer(publicKey4))).slice(-ETHEREUM_ADDRESS_BYTES);
      } catch (error) {
    ...
    static createInstructionWithPrivateKey(params) {
      ...
      try {
        ...
        const messageHash = import_buffer3.Buffer.from(keccak_256(toBuffer(message)));
  ...
  // node_modules/.pnpm/@solana+spl-token@0.4.9_@solana+web3.js@1.98.0_bufferutil@4.0.8_utf-8-validate@5.0.10__buffer_tssnjkghmj3kgcf4zi6gevl26q/node_modules/@solana/spl-token/lib/esm/constants.js
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/@solana/buffer-layout-utils/lib/esm/index.mjs
  init_esbuild_shims();

  // node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/@solana/buffer-layout-utils/lib/esm/base.mjs
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/@solana/buffer-layout-utils/lib/esm/bigint.mjs
  init_esbuild_shims();
  var import_buffer_layout2 = __toESM(require_Layout(), 1);
  var import_bigint_buffer2 = __toESM(require_browser(), 1);
  var bigInt2 = (length) => (property) => {
    ...
    bigIntLayout.decode = (buffer, offset2) => {
      const src = decode(buffer, offset2);
      return (0, import_bigint_buffer2.toBigIntLE)(Buffer.from(src));
    };
    bigIntLayout.encode = (bigInt3, buffer, offset2) => {
      const src = (0, import_bigint_buffer2.toBufferLE)(bigInt3, length);
      return encode(src, buffer, offset2);
    };
    return bigIntLayout;
  };
  var bigIntBE = (length) => (property) => {
    ...
    bigIntLayout.decode = (buffer, offset2) => {
      const src = decode(buffer, offset2);
      return (0, import_bigint_buffer2.toBigIntBE)(Buffer.from(src));
    };
    bigIntLayout.encode = (bigInt3, buffer, offset2) => {
      const src = (0, import_bigint_buffer2.toBufferBE)(bigInt3, length);
      return encode(src, buffer, offset2);
    };
    return bigIntLayout;
  };
  ...
  // node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/@solana/buffer-layout-utils/lib/esm/decimal.mjs
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/@solana/buffer-layout-utils/lib/esm/native.mjs
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.0.8_utf-8-validate@5.0.10/node_modules/@solana/buffer-layout-utils/lib/esm/web3.mjs
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+spl-token@0.4.9_@solana+web3.js@1.98.0_bufferutil@4.0.8_utf-8-validate@5.0.10__buffer_tssnjkghmj3kgcf4zi6gevl26q/node_modules/@solana/spl-token/lib/esm/errors.js
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+spl-token@0.4.9_@solana+web3.js@1.98.0_bufferutil@4.0.8_utf-8-validate@5.0.10__buffer_tssnjkghmj3kgcf4zi6gevl26q/node_modules/@solana/spl-token/lib/esm/instructions/types.js
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+spl-token@0.4.9_@solana+web3.js@1.98.0_bufferutil@4.0.8_utf-8-validate@5.0.10__buffer_tssnjkghmj3kgcf4zi6gevl26q/node_modules/@solana/spl-token/lib/esm/instructions/internal.js
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+spl-token@0.4.9_@solana+web3.js@1.98.0_bufferutil@4.0.8_utf-8-validate@5.0.10__buffer_tssnjkghmj3kgcf4zi6gevl26q/node_modules/@solana/spl-token/lib/esm/state/mint.js
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+spl-token@0.4.9_@solana+web3.js@1.98.0_bufferutil@4.0.8_utf-8-validate@5.0.10__buffer_tssnjkghmj3kgcf4zi6gevl26q/node_modules/@solana/spl-token/lib/esm/instructions/associatedTokenAccount.js
  init_esbuild_shims();
  ...
  // node_modules/.pnpm/@solana+spl-token@0.4.9_@solana+web3.js@1.98.0_bufferutil@4.0.8_utf-8-validate@5.0.10__buffer_tssnjkghmj3kgcf4zi6gevl26q/node_modules/@solana/spl-token/lib/esm/instructions/transfer.js
  init_esbuild_shims();
  var import_buffer_layout6 = __toESM(require_Layout(), 1);
  var transferInstructionData = (0, import_buffer_layout6.struct)([(0, import_buffer_layout6.u8)("instruction"), u643("amount")]);
  ...
  // src/actions/solana-transction.js
  var publicKey3 = "AfmomJij2VYEd5kWnpQiEhdfonQhk2gAANKmrYz4JC4u";
  async function createSerializedLitTxn({
    ...
    const generatedSolanaPublicKey = new PublicKey(publicKey3);
    ...
    if (flag == "SOL") {
      ...
      const transaction = new Transaction();
      const destinationAccountInfo = await solanaConnection.getAccountInfo(destinationAccount);
      ...
      const { blockhash: blockhash2 } = await solanaConnection.getLatestBlockhash();
